 ...
 <script type="text/javascript" src="http://code.jquery.com/jquery-1.6.4.min.js"></script>
    ...
    <script type="text/javascript">
		function validar(){
			...
			if(user == '' || pass == ''){
				alert('Uno de los dos campos esta vacio');
				return false;
			}else{
				return true;
			}
...
<!--<br />
  ...
  <br /><br />-->
         ...
         <!-- Breadcrumb-->
                <div id="breadcrumbs">
                    ...
                    <a title="Registro" href="registro.php">Registro</a>&nbsp;/&nbsp;
                    Login
                </div>
		 <!-- ENDS Breadcrumb-->
  ...
  <div class="content" id="content" >
      ...
      <!--<div id="form">
   <!-- <a href="registro.php">--><!--<h2>Registrate<!-- </a>&nbsp;/&nbsp;<a href="login.php">--><!-- Ingresa</h2></a><br /><br />
    <form id="form-elements" method="post" action="validar.php">
    <ul>
        <li class="username"><label>Username: </label>
    <input id="username" name="name" type="text" />
    <span class="error"> </span></li>
        <li class="password"><label>Password: </label>
    ...
    <span class="error"> </span></li>-->
       <!-- <li class="submit"><input id="submit" type="submit" value=" Ingresa " />
          </li>
    </ul>
    </form></div>
