...
<!--<br />
  ...
  <br /><br />
  <label style="margin-left:40px;"><h2>Bolsa de Trabajo</h2></label><br /><br />
  
  <img style="float:right;" src="Imagenes/busco-empleo.jpg" /><br />
  
  <p>La Agencia FLORENSE, te ofrece la oportunidad de unirte a nuestro grupo de enfermeras, garantizando una gran calidad que
  nos avala, así como el prestigio con el que se cuenta</p><br />
  
  <p>El objetivo de una enfermera es el siguiente :</p><br />
  
   <p> Realizar el trabajo o servicio de enfermería de acuerdo a las necesidades del enfermo y en estricto apego al <a href="">reglamento interno</a> y a las instrucciones particulares de  la coordinadora general. </p><br />
    <p>Este personal está disponible en  tiempo y forma para el momento que sean llamadas a trabajar en los horarios que se han establecido 
    en el reglamento interno.</p><br />
    
    <p>Y contando como funciones, el realizar acciones y/o cuidados de enfermería en el domicilio  y horario señalado, con ética y profesionalismo.</p><br />
    
    <p>Si has decidido unirte, puedes mandarnos tu curriculum!</p><br />
    
    <form action="envio_correo/envio_wetpets.php" method="post" enctype="multipart/form-data">
        <input type="file" id="txtcurriculum" name="txtcurriculum" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" id="btnenviar" name="btnenviar" value="Enviar" /><br />
        ...
        <div style="margin-left:160px; margin-top:-90px; ">
            <input name="tmptxt" type="text" id="tmptxt" maxlength="6" onKeyPress="return handleEnter(this, event)" style="width:80px; height:20px; margin-top:20px;" required="required" />               
        </div><br>
    </form>
